...
<alert type="warning">
  ...
  This command will make changes to your `App.vue`, components folder, vue.config.js, etc. If you are adding vuetify to an existing project, please make sure you   commit your code to avoid any data loss.  
